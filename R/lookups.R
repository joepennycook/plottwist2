pattern_lookup <- list("vertical" = list("x" = c(1, 1),
                                         "y" = c(0, 1),
                                         "id" = c(1, 1),
                                         "solid_x" = NULL,
                                         "solid_y" = NULL,
                       ...
                       "forward_diagonal" = list("x" = c(0, 1),
                                                 ...
                                                 "ratio" = 1,
                                                 "invert" = FALSE),
                       "backward_diagonal" = list("x" = c(1, 0),
                                                  "y" = c(0, 1),
                                                  "id" = c(1, 1),
                                                  "solid_x" = NULL,
                                                  "solid_y" = NULL,
                                                  ...
                                                  "ratio" = 1,
                                                  "invert" = FALSE),
                       "orthogonal_hatch" = list("x" = c(0, 1, 1),
                                                 "y" = c(1, 1, 0),
                                                 "id" = c(1, 1, 1),
                                                 "solid_x" = NULL,
                                                 "solid_y" = NULL,
                                                 ...
                                                 "ratio" = 1,
                                                 "invert" = FALSE),
                       "diagonal_hatch" = list("x" = c(0, 1, 1, 0),
                                               "y" = c(0, 1, 0, 1),
                                               "id" = c(1, 1, 2, 2),
                                               "solid_x" = NULL,
                                               "solid_y" = NULL,
